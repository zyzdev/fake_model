...
class FakeModel {
  ...
  /// Decide `fake model generative function` will return `final model` or `new instance model`.
  /// The property value of `final model` was decided once when 'fake model generative function' was generated,
